...
```
#### Much more examples and a detailed description can be found at [📄 Shopping carts documentation page](https://mdbootstrap.com/docs/standard/extended/shopping-carts/)
